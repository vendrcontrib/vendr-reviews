(function () {
        ...
        vm.performDelete = function () {
            ...
            vendrProductReviewsResource.deleteReview(id)
                .then(function () {
                    ...
                    // Notify views
                    $rootScope.$broadcast("vendrProductReviewDeleted", {
                        entityType: nodeType,
                        entityId: id,
                        storeId: storeId,
                        parentId: parentId
    ...
    angular.module('vendr').controller('Vendr.ProductReviews.Controllers.Dialog.DeleteController', DeleteController);
